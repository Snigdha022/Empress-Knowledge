   ...
   <div class="row">
       ...
       <div class="col-md-8">
          <table class="table table-hover" width="900px" style="text-align: center">
             <tr class="table-info">
                  <th class="table-info">Author ID</th>
                  <th class="table-info">Author Name</th>
                  ...
                  $query_run=mysqli_query($conn, $query);		
                      ...
                      while($row = mysqli_fetch_assoc( $query_run)){
                         ...
                         <tr>
                          ...
                          <td class="table-danger"><?php echo $row['author_id']; ?></td>
                          <td class="table-danger"><?php echo $row['author_name']; ?></td>
                          <td class="table-danger"><button type="button" class="btn btn-light" name=""> <a href="edit_auth.php?authid=<?php echo $row['author_id']; ?>">Edit </a></button>
                          <button type="button" class="btn btn-light" name="" ><a href="delete_auth.php?authid=<?php echo $row['author_id']; ?>">Delete </a></button>
                          </td>
