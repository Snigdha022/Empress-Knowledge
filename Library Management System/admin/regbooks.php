<?php
  ...
  $servername = "localhost"; 
        ...
        $book_price="";
		  ...
		  // $query = "SELECT books.book_name,books.book_no,books.book_price,authors.author_name from books left
              ...
              <?php
                      ...
                      while($row = mysqli_fetch_assoc( $query_run)){
                          ...
                          <tr class="table-warning">
                             <td class="table-danger"><?php echo $book_name; ?></td>
                             <td class="table-danger"><?php echo $author_name; ?></td>
                             <td class="table-danger"><?php echo $book_price; ?></td>
                             <td class="table-danger"><?php echo $book_no; ?></td>
