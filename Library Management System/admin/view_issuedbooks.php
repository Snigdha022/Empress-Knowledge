<?php
  ...
  $servername = "localhost"; 
        ...
        $query = "SELECT issued_books.book_name,issued_books.book_no,issued_books.book_author,users.name from issued_books left
        join users on issued_books.student_id=users.id "; 	
...
<html>
<head>
   <title>Details of Issued Book</title>
      ...
      <div class="col-md-8">
          <form>
           <table class="table table-hover" width="900px" style="text-align: center">
              <tr class="table-info">
                  <th class="table-warning">Name of Book</th>
                  <th class="table-warning">Book Number</th>
                  <th class="table-warning">Author of Book</th>
                  <th class="table-warning">Name of Student</th>
              ...
              <?php
                      ...
                      while($row = mysqli_fetch_assoc( $query_run)){
                          ...
                          <tr class="table-warning">
                             <td class="table-success"><?php echo $book_name; ?></td>
                             <td class="table-success"><?php echo $author_name; ?></td>
                             <td class="table-success"><?php echo $book_no; ?></td>
                             <td class="table-success"><?php echo $student_name; ?></td>
