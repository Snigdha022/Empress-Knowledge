...
<body>
  <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #a1ffe1">
    <div class="container-fluid">
	   <div class="navbar-header">
	   
	   <a class="navbar-brand" href="admindex.php" <font style="color:#162e26" >Library Management Sytem(LMS)</font></a></div>
	   <font style="color:#162e26"><span><strong>Welcome:<?php echo $_SESSION['name'];?></strong></span></font>
	   <font style="color:#162e26"><span><strong>Email:<?php echo $_SESSION['email'];?></strong></span></font>
      ...
      <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
	   ...
	   <li class="nav-item">
       <a class="nav-link active" href="../logout.php" style="color:#162e26">Log Out</a>
       </li>
	    </ul>
	</div>   
  </nav>
  <nav class="navbar navbar-expand-lg navbar-light" style="background-color:#f5dabc">
  <div class="container-fluid">
  ...
  <span><marquee>This is Library Management Sytem. Library opens at 8.00AM and closes at 6.00PM</marquee></span><br><br>
   <div class="row">
       ...
       <div class="col-md-4">
           <form action="addauth_action.php" method="post">
              <div class="form-group">
                 <label for="inputEmail3" class="col-sm-2 col-form-label">Author Name</label>
                   <div class="col-sm-10">
                       <input type="text" class="form-control" id="inputEmail3" placeholder="Author Name" name="author_name" required="">
                   </div>
              </div><br>
              
              <button type="submit" class="btn btn-outline-secondary" style="background-color: #a1ffe1" name="add_auth">Add Author</button>
           </form>
       </div>
       <div class="col-md-4"></div>
