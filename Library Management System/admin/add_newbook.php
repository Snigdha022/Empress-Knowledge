...
<body>
  <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #edc2ff">
    <div class="container-fluid">
	   ...
	   <a class="navbar-brand" href="admindex.php" <font style="color:#2a1333" >Library Management Sytem(LMS)</font></a></div>
      ...
      <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
        ...
        <li><a class="tn-secondarydropdown-item" href="adminchange_password.php">Change Password</a></li>
      </ul>
    </div>
	   <li class="nav-item">
   ...
   <div class="row">
       ...
       <div class="col-md-4">
           <form action="addbook_action.php" method="post">
              ...
              <div class="form-group">
                 <label for="inputEmail3" class="col-sm-2 col-form-label">Book Author</label>
                   <div class="col-sm-10">
                       <input type="text" class="form-control" id="inputEmail3" placeholder="Book Author" name="author_name" required="">
                   </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                 <label for="inputEmail3" class="col-sm-2 col-form-label">Book No</label>
                   <div class="col-sm-10">
                       <input type="text" class="form-control" id="inputEmail3" placeholder="Book No" name="book_no" required="">
                   </div>
              </div>
              <div class="form-group">
                 <label for="inputEmail3" class="col-sm-2 col-form-label">Book Price</label>
                   <div class="col-sm-10">
                       <input type="text" class="form-control" id="inputEmail3" placeholder="Book Price" name="book_price" required="">
                   </div>
              </div><br>
              <button type="submit" class="btn btn-outline-secondary" style="background-color: #edc2ff" name="add_book">Add Book</button>
