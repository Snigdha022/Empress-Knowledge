   ...
   <div class="row">
       ...
       <div class="col-md-8">
          <table class="table table-hover" width="900px" style="text-align: center">
             <tr class="table-info">
                  <th class="table-info">Category ID</th>
                  <th class="table-info">Category Name</th>
                  ...
                  $query_run=mysqli_query($conn, $query);		
                      ...
                      while($row = mysqli_fetch_assoc( $query_run)){
                         ...
                         <tr>
                          ...
                          <td class="table-danger"><?php echo $row['cat_id']; ?></td>
                          <td class="table-danger"><?php echo $row['cat_name']; ?></td>
                          <td class="table-danger"><button type="button" class="btn btn-light" name=""> <a href="edit_cat.php?cid=<?php echo $row['cat_id']; ?>">Edit </a></button>
                          <button type="button" class="btn btn-light" name="" ><a href="delete_cat.php?cid=<?php echo $row['cat_id']; ?>">Delete </a></button>
                          </td>
